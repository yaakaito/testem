...
Config.prototype.getAvailableLaunchers = function(app, cb){
    ...
    browser_launcher.getAvailableBrowsers(function(availableBrowsers){
        ...
        var ignores = self.get('ignore_browsers') || null
        availableBrowsers.forEach(function(browser){
            if (ignores === null || ignores.indexOf(browser.name) === -1) {
...
Config.prototype.getCoverageDir = function(cb) {
    var defaultDir = '/coverages'
    var self = this;
    return self.resolvePath(defaultDir);
